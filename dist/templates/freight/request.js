...
`;
const FREIGHTREQUEST_BATCH_MADE_TO_ADMIN_TEMPLATE = `
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head>
  <meta http-equiv="Content-Type" content="text/html; charset=UTF-8" />
  <meta name="viewport" content="width=device-width, initial-scale=1.0"/>
  <title>New Batch Freight Request</title>
  <style type="text/css">
  body { margin: 0; padding: 0; min-width: 100%; background-color: #f4f7f9; font-family: 'Helvetica Neue', Helvetica, Arial, sans-serif; }
  table { border-spacing: 0; font-family: sans-serif; color: #333333; }
  td { padding: 0; }
  ...
  .info-label { font-weight: bold; color: #64748b; width: 40%; }
  .info-value { color: #1e293b; font-weight: 600; }
  .badge { display: inline-block; background-color: #fef3c7; color: #92400e; font-weight: bold; font-size: 13px; padding: 6px 14px; border-radius: 20px; margin-bottom: 15px; }
  h2 { color: #1e293b; font-size: 22px; margin-top: 0; margin-bottom: 20px; }
  p { margin-bottom: 15px; color: #475569; }
</style>
</head>
<body>
  <center class="wrapper">
    <table class="main" width="100%">
      ...
      <tr>
        <td class="content">
          <span class="badge">{{QUANTITY}} IDENTICAL REQUESTS</span>
          <h2>New Batch Freight Request Received</h2>
          <p>Hello Admin,</p>
          <p>A customer has submitted <strong>{{QUANTITY}} identical freight requests</strong> in one batch. Here are the shared details:</p>
          <table class="info-table">
            <tr>
              <td class="info-td info-label">Origin Port</td>
              <td class="info-td info-value">{{ORIGIN_PORT}}</td>
            ...
            <tr>
              <td class="info-td info-label">Cargo Weight (each)</td>
              <td class="info-td info-value">{{CARGO_WEIGHT}} kg</td>
            </tr>
            <tr>
              <td class="info-td info-label" style="border-bottom: none;">Proposed Price (each)</td>
              <td class="info-td info-value" style="border-bottom: none; color: #0f172a;">{{PROPOSED_PRICE}} USD</td>
            </tr>
          </table>
          <p>Please review this batch in the admin dashboard to take action on all {{QUANTITY}} requests at once.</p>
          <table width="100%">
            <tr>
              <td class="button-container">
                <a href="{{DASHBOARD_LINK}}" class="button">View Batch in Dashboard</a>
              </td>
            </tr>
          </table>
          <p>For more information, please see more details in your dashboard or contact the support team of <strong>Freight Afford</strong>.</p>
...
`;
export { FREIGHTREQUEST_BATCH_MADE_TO_ADMIN_TEMPLATE, FREIGHTREQUEST_MADE_TO_ADMIN_TEMPLATE, };
