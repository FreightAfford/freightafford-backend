...
freightRouter.get("/:id", authorize("admin", "customer"), catchAsync(getFreightRequest));
freightRouter.patch("/admin/:id/accept", authorize("admin"), catchAsync(acceptFreightRequest));
freightRouter.patch("/admin/:id/counter", authorize("admin"), catchAsync(counterFreightRequest));
freightRouter.patch("/admin/:id/reject", authorize("admin"), catchAsync(rejectFreightRequest));
