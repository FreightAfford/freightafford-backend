...
import { passwordResetEmail, resendOTPEmail, sendOTPEmail, } from "../services/auth-email.service.js";
import ApiFeatures from "../utils/api-features.js";
import { generateJWT } from "../utils/jwt.js";
import { generateOTP, hashToken } from "../utils/otp.js";
import { comparePassword, hashPassword } from "../utils/password.js";
import { formatPhoneNumber, normalizePhoneNumber, } from "../utils/phone-format.js";
...
export const updateUserByAdmin = async (req, res, next) => {
    const { userId } = req.params;
    const { fullname, email, status, phoneNumber, country, companyName, companyAddress, } = req.body;
    const user = await User.findById(userId);
    if (!user)
        return next(new AppError("User not found", 404));
    let normalizedPhone = user.phoneNumber;
