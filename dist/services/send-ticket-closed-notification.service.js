// services/send-ticket-closed-notification.service.ts
import { resend } from "./email.service.js";
export const sendTicketClosedNotification = async (email, ticketId, subject) => {
    return await resend.emails.send({
        from: "FreightAfford Support <exports.ng@info.freightafford.com>",
        to: email,
        subject: `[${ticketId}] Your support ticket has been closed`,
        text: `Hello,\n\nYour support ticket #${ticketId} regarding "${subject}" has been automatically closed after 7 days of inactivity.\n\nIf you still need assistance, please open a new ticket or reply to any of our previous emails.\n\nRegards,\nThe Freight Afford Support Team`,
        html: `
    ...
    <table class="main" width="100%">
      ...
      <tr>
        <td class="content">
          ...
          <p>Hello ${email},</p>
          <p>Your support ticket has been <strong>automatically closed</strong> after 7 days of inactivity. We hope your issue was resolved!</p>

          <table class="info-table">
            <tr>
              <td class="info-td info-label">Ticket ID</td>
              <td class="info-td info-value">#${ticketId}</td>
            </tr>
            <tr>
              <td class="info-td info-label">Subject</td>
              <td class="info-td info-value">${subject}</td>
            </tr>
            <tr>
              <td class="info-td info-label" style="border-bottom: none;">Status</td>
              <td class="info-td info-value" style="border-bottom: none;">
                <span style="background-color: #f1f5f9; color: #475569; padding: 4px 8px; border-radius: 4px; font-size: 12px; font-weight: bold;">Closed</span>
              </td>
            </tr>
          </table>

          <p>If you still need assistance or your issue was not resolved, feel free to open a new ticket — we're always here to help.</p>

          <table width="100%">
            <tr>
              <td class="button-container">
                <a href="https://freightafford.com/app/customer" class="button">Open a New Ticket</a>
              </td>
            </tr>
          </table>
...
//# sourceMappingURL=send-ticket-closed-notification.service.js.map