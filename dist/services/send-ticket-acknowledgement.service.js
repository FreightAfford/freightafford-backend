...
export const sendTicketAcknowledgement = async (email, ticketId, subject) => {
    ...
    Our support team will review it and respond shortly.
    FreightAfford Logistics Support`,
        html: `
    ...
    <td class="header">
      ...
      <tr>
        <td class="content">
          ...
          <p>Hello ${email},</p>
          <p>Thank you for reaching out to <strong>Freight Afford Logistics</strong>. This email is to confirm that we have received your support request and our team is currently looking into it.</p>
          ...
          <table class="info-table">
            ...
            <tr>
              <td class="info-td info-label" style="border-bottom: none;">Subject</td>
              <td class="info-td info-value" style="border-bottom: none;">${subject}</td>
            </tr>
          </table>

          <p>We typically respond within 24 hours. In the meantime, Please ensure you reply any of our email response to keep track of your request status.</p>
          
          <table width="100%">
            <tr>
              <td class="button-container">
                <a href="https://freightafford.com/app/customer" class="button">View Ticket Status</a>
              </td>
            </tr>
          </table>
...
//# sourceMappingURL=send-ticket-acknowledgement.service.js.map