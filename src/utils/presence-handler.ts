...
const onlineCSOs = new Map<string, string>(); // userId → socket.id
...
export const isCSOOnline = (userId: string): boolean => onlineCSOs.has(userId);
export const getOnlineCSOs = (): string[] => Array.from(onlineCSOs.keys());
